-- If a season somehow has zero roster members, archiving hit a generic "Member
-- decisions are required" error with no clue why — the app-level check now
-- explains it clearly, but this direct-RPC-call guard should say the same thing.
